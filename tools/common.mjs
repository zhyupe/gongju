...
const pinyinToneRegex = new RegExp(
  `[${Object.keys(pinyinToneMarks).join('')}]`,
  'g',
)

// 过滤数据集中混在汉语拼音中的粤语拼音
export const pinyinRegex =
  /^(?:[bpmfdtnlgkhjqxryw]|[zcs]h?)?(?:[aeiouv]|ai|ei|ui|ou|uai?|uo|ia|iu|[iuv]e|er|[aeiuv]n|[aeio]ng|i?ao|iong|iang?|uang?)?$/
